                        ...
                        <div class="causes-item causes-item--style-2">
                            <div class="causes-item__body">
                                <div class="causes-item__action">
                                    <h6 class="causes-item__title"> <a href="cause-details.html">Username</a></h6><a class="button causes-item__button button--primary d-none d-sm-inline-block" href="#">+ Donate	</a>
                                </div>
                                ...
                                <div class="causes-item__lower">
                                    ...
                                    <div class="causes-item__details-holder">
                                        <div class="causes-item__details-item"><span>Blood Group: </span><span>O-</span></div>
                                        <div class="causes-item__details-item text-right"><span>No Of Bottles: </span><span>4</span></div>
                                    </div><a class="button causes-item__button button--primary d-sm-none" href="#">+ Donate	</a>
                                </div>
                            </div>
                        </div>
                    </div>
